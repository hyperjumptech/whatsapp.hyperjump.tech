        ...
        <div className="flex py-6">
          ...
          <div className="items-center justify-end hidden lg:flex md:flex-1 lg:w-0">
            <ul className="flex flex-row list-none lg:ml-auto">
              ...
              <li className="nav-item">
                <Link href="/">
                  <span className="flex items-center px-3 py-2 font-sans font-bold leading-snug text-white underline hover:opacity-75">
        ...
        <div className="bg-white divide-y-2 rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 divide-gray-50">
          <div className="px-5 py-6 space-y-6">
            <ul>
              ...
              <li className="nav-item">
                <Link href="/">
                  <span className="flex items-center px-3 py-2 font-sans font-bold leading-snug underline text-monika-black hover:opacity-75">
                    {" "}
